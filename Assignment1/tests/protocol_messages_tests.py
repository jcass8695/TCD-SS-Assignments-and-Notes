...
class TestValidations(unittest.TestCase):
    ...
    def test_leave(self):
        self.assertTrue(check_leave("LEAVE_CHATROOM: 123\nJOIN_ID: 456\nCLIENT_NAME: client_1\n"))
        ...
        self.assertFalse(check_leave("LEAVE_CHATROOM: room_1\nJOIN_ID: 456\nCLIENT_NAME: client_1\n"))

        self.assertFalse(check_leave("LEAVE_CHATROOM: 123\nJOIN_ID: fourfivesix\nCLIENT_NAME: client_1\n"))

    def test_disconnect(self):
        self.assertTrue(check_disconnect("DISCONNECT: 0\nPORT: 0\nCLIENT_NAME: client_1\n"))
        self.assertTrue(check_disconnect("DISCONNECT: 0\nPORT: 0\nCLIENT_NAME: client 1\n"))
        self.assertTrue(check_disconnect("DISCONNECT: 0\nPORT: 0\nCLIENT_NAME: mad max 21\n"))
        self.assertTrue(check_disconnect("DISCONNECT: 0\nPORT: 0\nCLIENT_NAME: mad_max_21\n"))
        self.assertFalse(check_disconnect("DISCONNECT: 10\nPORT: 0\nCLIENT_NAME: client_1\n"))
        self.assertFalse(check_disconnect("DISCONNECT: 0\nPORT: 10\nCLIENT_NAME: client_1\n"))
        self.assertFalse(check_disconnect("DISCONNECT: 0\nPORT: 0\nCLIENT_NAME: \n"))
        self.assertFalse(check_disconnect("DISCONNECT: 0\nPORT: 0\nCLIENT_NAME:client_1\n"))
    ...
    def test_message(self):
        self.assertTrue(check_message("CHAT: 21\nJOIN_ID: 123\nCLIENT_NAME: jack\nMESSAGE: This is a message\n\n"))
        ...
        self.assertFalse(check_message("CHAT: chatroom1\nJOIN_ID: 123\nCLIENT_NAME: jack\nMESSAGE: This is a message\n\n"))

        self.assertFalse(check_message("CHAT: 21\nJOIN_ID: player1\nCLIENT_NAME: jack\nMESSAGE: This is a message\n\n"))
    ...
    def test_parse_join(self):
        chatroom_name, client_name = parse_join("JOIN_CHATROOM: chatroom_1\nCLIENT_IP: 0\nPORT: 0\nCLIENT_NAME: client_1\n")
        self.assertEqual(chatroom_name, "chatroom_1")
        self.assertEqual(client_name, "client_1")

        chatroom_name, client_name = parse_join("JOIN_CHATROOM: chatroom 1\nCLIENT_IP: 0\nPORT: 0\nCLIENT_NAME: client 1\n")
